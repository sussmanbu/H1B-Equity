...
ggplot(filtered_df, aes(x = log(PREVAILING_WAGE), y = log(WAGE_RATE_OF_PAY_FROM) )) +
  ...
  geom_smooth(method = "lm", se = FALSE) +  # Adds a linear regression line without the confidence interval
...
**Note** that PERM_DISCLOSURE_DATA is almost the identical as LCA_Program data but PERM_DISCLOSURE_DATA contains more columns.
