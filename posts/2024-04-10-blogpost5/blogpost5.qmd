...
```{r}
# top 5 job_title in this dataset
...
Looking at the result of KMeans with only two numerical columns, it was not necessary to make use of Kmeans because is obvious to notice a linear relationship. There's a positive correlation between these two features. As one increases, other tends to increase.
