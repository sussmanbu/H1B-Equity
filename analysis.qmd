...
After removing this outlier, the dataset is split 90/10 into training and test sets, and the linear regression model is built on the training set.
...
The model's predictive performance of the testing set has a RSME of 48892.1392. ![Total number of H1B applications in 2020-2024](images/ActualvsPredicted.png)
