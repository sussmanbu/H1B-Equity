...
We joined the Perm Disclosure datasets with IMF GDP and Unemployment rates for each country. Grouped by country, we find a correlation matrix, where the education level is made into a categorical variable.
...
With the information from this correlation matrix, we can build an initial linear regression model of Wage ~ GDP per Capita + Unemployment. THis linear model has the following statistics:
...
By plotting the diagnostics, we can see a clear outlier that is affecting the strength of the model:
...
Using Cook's Distance, we can see that this outlier represents Nigeria, which has an average H1-B applicant wage of $6,524,999, a GDP of 1945.012,	and an unemployment rate of 22.6.
After removing this outlier, we can splot the dataset 90/10 into training and test sets, and build the linear regression model on the training set.
The model's predictive performance of the testing set has a RSME of 48892.1392815258. and the following:
[1] "Baseline RMSE using mean:  55500.5606201905"
[1] "Baseline RMSE using median:  55665.7830713718"
[1] "Model RMSE:  48892.1392815258"
[1] "Improvement over mean baseline:  6608.42133866472"
[1] "Improvement over median baseline:  6773.64378984599"
