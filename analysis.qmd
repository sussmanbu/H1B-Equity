...
The Perm Disclosure datasets are joined with IMF GDP and Unemployment rates for each country. Grouped by country, the data has the following correlation matrix, where the education level is made into a categorical variable.
